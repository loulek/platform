  ...
  if (!_moment) {
    if (options && options.moment) {
      if (options.moment.settings) {
        ...
        _moment3.default.locale(options.moment.lang);
      }
    } else {
      _moment3.default.updateLocale('en', {
        week: { dow: 1 },
...
function initializeOptions(options, uuid) {
  _options[uuid] = (0, _omit2.default)(options, 'moment');
}
...
function getStyle(page, props, uuid) {
  ...
  var options = (0, _assign2.default)(defaultOptions, _options[uuid]);
